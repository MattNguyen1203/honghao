...
import {DialogClose} from '@/components/customCn/dialogFormhome'
...
export default function HomeForm({
  ...
  const [paxValueSelf, setPaxValueSelf] = useState(selfPax || 0)
        ...
        <div
          className={`${
            isTourDetail
              ...
              : 'bg-white xmd:!pb-[7.5rem] xmd:w-full xmd:space-y-[4rem]'
            ...
            >
              ...
              >
                ...
                <div className='flex xmd:flex-col w-full md:space-x-[0.75rem]'>
                  <div className='flex-1 flex space-x-[0.75rem] *:h-fit'>
                    <FormField
                      control={form.control}
                      name='pickup'
                      render={({field}) => (
                        <FormItem className='flex-1'>
                          ...
                          >
                            ...
                            <SelectContent className='min-w-[16rem] p-[1.25rem] rounded-[0.75rem] sahdow-[90px_128px_44px_0px_rgba(66,72,66,0.00),57px_82px_40px_0px_rgba(66,72,66,0.01),32px_46px_34px_0px_rgba(66,72,66,0.05),14px_20px_25px_0px_rgba(66,72,66,0.09),4px_5px_14px_0px_rgba(66,72,66,0.10)]'>
                              {listLocation?.pickup_location?.map(
                                (e, index) => (
                                  <>
                                    <SelectItem
                                      key={index}
                    ...
                    <FormField
                      ...
                      name='dob'
                      render={({field}) => (
                        <FormItem className='box !space-y-[0.4rem] flex flex-col justify-start flex-1 pt-[0.25rem] !h-fit'>
                          <FormLabel className='text-0875 font-bold text-greyscale-80 mb-[0.5rem]'>
                            Departure date
                          </FormLabel>
                          <FormControl>
