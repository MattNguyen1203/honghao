...
const Socials = ({dataAcf, listTypeofTour, listTime, listTours}) => {
  ...
  return (
    <div className='fixed z-[101] xmd:bottom-[5.2rem] bottom-[3.7rem] xmd:right-[0.5rem] right-[1.5rem] flex flex-col items-center xmd:space-y-[0.5rem] space-y-[1rem]'>
      ...
      <a
        ...
        href={`https://wa.me/${dataAcf?.contact_info?.phone}`}
        target='_blank'
      ...
      {/* <Mailto
        email={dataAcf?.contact_info?.email}
        // subject='Hello'
        // body='Hello HongHao'
      > */}
      <a
        className=''
        href={`mailto:${dataAcf?.contact_info?.email}`}
        // href={`https://mail.google.com/mail/?view=cm&fs=1&to=${dataAcf?.contact_info?.email}`}
        target='_blank'
      >
        <Image
          data-aos='fade-up'
