      ...
      <div className='flex flex-col items-start md:flex-row'>
        ...
        <div className='relative xmd:h-[35.25rem] flex-none xmd:-mx-4 md:basis-1/2 xmd:mt-12'>
          ...
          <Image
            ...
            height={844}
          />
          <div className='absolute top-0 left-0 w-full h-full bg-contact-us-gradient md:hidden !rounded-[2rem]' />
          <Link
            ...
            target='_blank'
            className='absolute bd top-[1.74rem] overflow-hidden left-[1.38rem] py-3 h-12 flex justify-center items-center px-6 !rounded-[2rem] backdrop-blur-[10px] text-orange-normal text-center font-tripsans text-0.875 font-extrabold leading-1.2 uppercase z-10 md:hidden'
