    ...
    <section className='relative w-full'>
      ...
      <div className='relative border border-transparent w-full '>
        ...
        >
          ...
          <div
            ref={menuRef}
            className=' xmd:mt-[5rem] md:z-[10000] mt-[1.75rem] w-full h-[6.25rem] flex justify-center items-center shrink-0'
          >
                ...
                >
                  {listsImageCurrent && (
                    <Image
                      priority
                      alt='ảnh'
                      src={listsImageCurrent[0]?.image}
                      width={500}
                      height={500}
                      className=' group-hover:scale-110 w-full !h-full absolute top-0 bottom-0 left-0 duration-500 ease-linear  cursor-pointer '
                    />
                  )}
                </Video>
                <ImageBig>
                  {listsImageCurrent && (
                    <Image
                      priority
                      alt='ảnh'
                      src={listsImageCurrent[1]?.image}
                      width={500}
                      height={500}
                      className=' group-hover:scale-110 w-full h-full duration-500 ease-linear  cursor-pointer '
                    />
                  )}
                </ImageBig>
                <ImageNormal>
                  ...
                  <ImageSmall>
                    {listsImageCurrent && (
                      <Image
                        priority
                        alt='ảnh'
                        src={listsImageCurrent[10]?.image}
                        width={500}
                        height={500}
                        className=' group-hover:scale-110 w-full h-full duration-500 ease-linear  cursor-pointer '
                      />
                  ...
                  <ImageSmall>
                    {listsImageCurrent && (
                      <Image
                        priority
                        alt='ảnh'
                        src={listsImageCurrent[11]?.image}
                        width={500}
                        height={500}
                        className=' group-hover:scale-110 w-full h-full duration-500 ease-linear  cursor-pointer '
                      />
