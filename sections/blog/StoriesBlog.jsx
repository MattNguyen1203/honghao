...
const TitleBeauty = ({ children }) => {
  return (
    <div className="mt-[1.75rem] w-full relative xmd:mt-[1.45rem] inline-flex z-10 items-end  justify-between xmd:space-x-[1.25rem] space-x-[1.75rem]">
      ...
      <div className="flex mb-[0.4rem] items-center xmd:space-x-[0.56rem]  space-x-[1.875rem]">
      ...
      <div className='flex flex-col xmd:relative items-center gap-[3.9375rem]'>
        <div className='flex flex-col items-center xmd:space-y-[1.5rem] space-y-[2.8125rem]'>
          ...
          <div data-aos="fade-up"
            data-aos-duration="900" className=' flex xmd:hidden flex-col w-[89.9375rem] items-center '>
            <Button>OUR BLOG</Button>
            <TitleBeauty>
          ...
          <div className=" xmd:space-y-[1.25rem] space-y-[4rem] w-full flex justify-end flex-col items-center">
            <div data-aos="fade-up"
              data-aos-duration="900" className='xmd:w-screen mx-auto  relative saveposition xmd:overflow-auto xmd:no-scrollbar xmd:px-[1rem] '>
