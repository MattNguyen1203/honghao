        ...
        <div className='!overflow-hidden bg-[#FAFAFA] h-[90vh] w-full rounded-tl-[2rem] rounded-bl-[2rem] shadow-[-206px_319px_106px_0px_rgba(13,48,33,0.00),-132px_204px_97px_0px_rgba(13,48,33,0.01),-50px_-10px_40px_0px_rgba(13,48,33,0.09),-8px_13px_33px_0px_rgba(13,48,33,0.10)] overflow-y-auto relative pt-[2.63rem] pl-[3.19rem]'>
          ...
          <div className='w-full h-[65vh] mt-[2.25rem] flex justify-between pr-[4.81rem]'>
                  ...
                  {dataSLides && (
                    ...
                    >
                      ...
                      {Array(
                        ...
                        .map((_, index) => (
                          <SwiperSlide
                            className='w-full relative h-[9.125rem]'
                            key={index}
                          >

                            {index === 0 && <div
                              onClick={() => handleClickDistrict(-1)}
                              className='cursor-pointer absolute left-[15%] top-0 z-10 flex flex-col translate-x-full'
                            >
                              <div
                                className={`${indexSlider >= 0
                                  ? 'bg-[#23704D] delay-500'
                                  : 'bg-[#C5C5C5]/80'
                                  }  size-[0.375rem] rounded-full absolute bottom-0 left-[-0.78rem] z-10 transition-all duration-200`}
                              ></div>
                              <IconMarker
                                className='size-[1.5rem]'
                                isActive={indexSlider >= 0}
                              />
                            ...
                            <div className='flex justify-center '>
                              ...
                              <div className='h-[9.125rem] w-[2px] bg-[#C5C5C5]/50 relative'>
                                ...
                                {/* line */}
                                <div
                                  className={`${indexSlider >= index + 1 && indexSlider !== 0 ? 'h-full' : 'h-0'
                                ...
                                >
                                  ...
                                  />
                                  <div onClick={() => handleClickDistrict(index)} className='text-[0.875rem] cursor-pointer font-extrabold leading-normal text-greyscale-20 whitespace-nowrap'>
            ...
            <Swiper
              ...
              modules={[Mousewheel]}
              className='w-full !h-[65vh] !mt-5 !mx-0'
            >
              {dataSLides?.map((item, index) => (
                <SwiperSlide
                  className={cn('w-full h-fit pb-[1.62rem] cursor-pointer')}
                  key={index}
                >
...
const ItemCardInfo = ({ item, active }) => {
  return (
    <article className={cn('min-h-[10.875rem] duration-100 border-[2px] transition-all rounded-[1.5rem] bg-[#F5F5F5] p-[1.88rem] xlg:p-[2rem] xmd:p-[1rem] xlg:rounded-[0.75rem] relative',
      active ? ' border-[2px] border-greyscale-30' : ' border-transparent'
    )}>
