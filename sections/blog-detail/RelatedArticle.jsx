  ...
  return (
    <section className='relative md:mt-[4.5rem]  md:h-[60.18244rem] xmd:h-[31.1875rem]'>
      ...
      <div className="xl:container flex flex-col items-center">
        ...
        <div className="xmd:mt-[1rem] mt-[6rem] inline-flex z-10 justify-center items-center gap-2.5 px-[2.125rem] py-[0.8125rem]  xmd:py-[0.5rem] xmd:px-[1.25rem] rounded-[62.5rem]
      ...
      ">
        ...
        <div className="mt-[3.3rem] xmd:w-full xmd:mt-[1.45rem] flex z-10 items-center xmd:justify-between xmd:space-x-[1.25rem] space-x-[1.75rem]">
          ...
          <div className="flex items-center xmd:space-x-[0.56rem]  space-x-[1.875rem]">
            ...
            <div className=' xmd:w-[2rem] w-[14.25813rem] h-[0.0625rem] bg-[rgba(217,217,217,0.28)]'>
            </div>
