...
const DialogCp = ({ children, data, video }) => {
  ...
  return (
    <Dialog className='Dialogclass' open={isOpen} onOpenChange={setIsOpen}>
      ...
      {isOpen && (
        <DialogContent className='!w-max'>
          <video className='w-[75rem]' ref={videoRef} >
            <source src={video} type="video/mp4" />
          </video>
          <DialogClose onClick={() => setIsOpen(false)} className='absolute top-[0rem] -right-[4rem]'>
      ...
      <div className='flex mt-[5.63rem] xl:container xmd:hidden flex-col items-start space-y-[3rem]'>
        ...
        <div className='flex items-start w-full  justify-between space-x-[4.68rem]'>
          ...
          <div className='relative w-[42.4485rem] h-[26.69638rem]'>
            ...
            <DialogCp data={[1, 1, 1, 1, 1]} video={videoAndImage?.video_faq?.url}>
