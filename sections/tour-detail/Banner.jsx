    ...
    <div className='relative'>
      ...
      <div className='relative xmd:container xmd:mt-[1.25rem] xl:container'>
            ...
            <div className="flex items-center space-x-[0.85rem] self-stretch">
              <div className="flex items-center space-x-[0.375rem]">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path className='xmd:fill-[#E64827]' opacity="0.4" d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" fill={"white"} />
                  <path className='xmd:fill-[#E64827]' d="M15.7106 15.9298C15.5806 15.9298 15.4506 15.8998 15.3306 15.8198L12.2306 13.9698C11.4606 13.5098 10.8906 12.4998 10.8906 11.6098V7.50977C10.8906 7.09977 11.2306 6.75977 11.6406 6.75977C12.0506 6.75977 12.3906 7.09977 12.3906 7.50977V11.6098C12.3906 11.9698 12.6906 12.4998 13.0006 12.6798L16.1006 14.5298C16.4606 14.7398 16.5706 15.1998 16.3606 15.5598C16.2106 15.7998 15.9606 15.9298 15.7106 15.9298Z" fill="white" />
                </svg>
              ...
              {data.slice(0, 2).map((d, i) => (
                <div key={i} className="flex flex-col items-start space-y-[0.75rem]">
                  ...
                  <ul className='pl-[1.6rem] w-[19rem]'>
                    ...
                    {d?.children.map((c, i) => (
                      <li key={i} className="list-disc  xmd:text-greyscale-80 text-white text-sm not-italic font-bold leading-[150%]">
                        {c?.text}
                      </li>
                    ))}
                  </ul>
        ...
        <div className="flex xmd:mt-[1.5rem] md:hidden justify-center items-center gap-[0.25rem]">
          <div className="text-[color:var(--Orange-Normal,#E64827)] text-sm not-italic font-extrabold leading-[150%] tracking-[0.00219rem]">SEE LESS</div>
          <svg className='w-[0.49956rem] h-[0.83356rem] shrink-0' xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="none">
            <path d="M6.02485 3.65534L2.86071 6.81934C2.70011 6.9801 2.50368 7.0603 2.27145 7.0603C2.03924 7.0603 1.8429 6.98008 1.68232 6.81934L1.19395 6.33113C1.03342 6.17062 0.953125 5.97417 0.953125 5.74203C0.953125 5.50989 1.03342 5.31352 1.19395 5.15276L5.43232 0.907935C5.59293 0.747307 5.78934 0.666992 6.02159 0.666992C6.25385 0.666992 6.45009 0.747284 6.61077 0.907935L10.8491 5.15274C11.0097 5.3135 11.09 5.50984 11.09 5.742C11.09 5.97417 11.0097 6.1706 10.8491 6.33111L10.3609 6.81931C10.2004 6.98008 10.005 7.06028 9.77488 7.06028C9.54491 7.06028 9.34741 6.98006 9.18249 6.81931L6.02485 3.65534Z" fill="#E64827" />
          </svg>
        </div>
        ...
        <div className=" absolute z-10 xmd:left-[13.5rem]  bottom-[3rem] md:left-1/2 md:-translate-x-1/2 md:bottom-[6rem] opacity-100 duration-500 ">
          <div className="relative">
            ...
            <Image priority alt="ảnh" src={'/imgs/all-destinations/honghao-xoay.png'} width={300} height={400} className="w-[11.375rem] xmd:hidden z-10 absolute top-0 circular-infinity " />
            <Image priority alt="ảnh" src={'/imgs/all-destinations/honghao-xoay-den.png'} width={300} height={400} className="w-[11.375rem] md:hidden z-10 absolute top-0 circular-infinity " />
          </div>
