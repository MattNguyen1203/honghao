...
const Banner = () => {
  ...
  return (
    <section className='relative xl:h-[100rem] overflow-y-hidden' >
      ...
      <Image priority alt="ảnh" src={'/imgs/about/nature-mobi.jpg'} width={1600} height={1935} className=" md:hidden absolute w-[23.5625rem] h-[59.35963rem] shrink-0" />


      <div className='xl:container relative xmd:h-[49.35963rem] md:left-[2rem] h-[100rem] xmd:mt-[5.3rem]'>
        {/* main title */}
        ...
        <Image priority alt="ảnh title mobi" src={'/imgs/about/main-title-mobi.png'} width={840} height={355} className=" left-[5rem] xmd:mx-auto top-[9rem] md:hidden w-[20.9605rem] h-[8.65rem]" />
        ...
        <Image priority alt="map mobi" src={'/imgs/about/map-mobi.png'} width={9950} height={9950} className="z-[1000] absolute bottom-[2rem] left-0 md:hidden" />
        {/* 10000 */}
        <div className="absolute w-[4.75rem] h-[6.25rem] left-[0rem] top-[20rem] md:left-[2.27rem] xl:left-[-1.9rem] md:top-[51.5rem]">
          <div className=' relative'>
            <div className=" absolute xmd:top-[12.4rem] xmd:left-[14.5rem] md:left-[50.5rem] md:top-[3rem] inline-flex flex-col items-center w-[8.75013rem]">
            ...
            <div className="xmd:top-[10rem] xmd:left-[5.5rem]  md:left-[63rem] absolute flex flex-col items-end xmd:space-y-[0.75rem]">
              <div className=" text-linear  text-[6.25rem] not-italic font-bold leading-[100%] uppercase xmd:text-[2.94194rem] relative">10.000
              </div>
        ...
        {/* 13 year */}
        <div className="absolute w-[4.75rem] h-[6.25rem] xl:left-[-3.6rem]  left-[-0.2rem] top-[65.5rem]">
          <div className=' relative '>
            <div className=" absolute top-[5rem] left-[18.2rem] md:left-[30rem] md:top-[7rem] xl:left-[29.4rem] xl:top-[7rem] inline-flex flex-col items-center w-[8.75013rem]">
              <svg className='circle size-[2.25rem] mr-[0.95rem]' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <circle cx="10" cy="10" r="3.5" fill="#E64827" stroke="#E64827" />
                <circle cx="10" cy="10" r="9.5" stroke="#E64827" />
              </svg>
            ...
            <div className="xmd:top-[4.5rem] left-[3.5rem] top-[4.3rem] absolute flex flex-col items-start xmd:space-y-[0.75rem] ">
              <div className=" text-linear w-max text-[6.25rem] not-italic font-bold leading-[100%] uppercase xmd:text-[2.94194rem] relative">13 year
              </div>
              <div className="text-white w-fit z-[500] bg-clip-border text-lg not-italic font-bold leading-[120%] flex 
                flex-col bg-[rgba(255,255,255,0.15)] items-start gap-4  backdrop-blur-lg xmd:px-[0.353rem] xmd:text-[0.52956rem] xmd:py-[0.1765rem] px-3 py-1.5 rounded-3xl">
