...
const Banner = ({ dataBanner, dataBannerMobi }) => {
  ...
  return (
    <section className='relative xl:h-[100rem] overflow-hidden' >
      <Image priority alt="ảnh" src={dataBanner?.image} width={1600} height={1935}
      ...
      <Image priority alt="ảnh" src={dataBannerMobi?.image} width={1600} height={1935} className=" md:hidden absolute w-full h-[49.35963rem] shrink-0" />


      <div className='xl:container  z-[6] relative xmd:h-[42.35963rem] md:left-[2rem] h-[100rem] xmd:mt-[6.9rem]'>
        {/* main title */}
        <Image priority alt="ảnh title web" src={dataBanner?.image_title_big} width={840} height={355} className=" xmd:ml-[1.5rem]  xmd:w-[19.098rem] xmd:h-[7.42925rem]  md:absolute md:left-[3rem]  xl:left-[0rem]  left-[0rem] top-[9rem] w-[57.44256rem] h-[22.1875rem]" />
