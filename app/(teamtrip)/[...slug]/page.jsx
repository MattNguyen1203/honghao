...
const page = async ({ params }) => {
  ...
  const dataDetailPost = await getData(`wp-json/okhub/v1/get-post-detail-by-slug/${params?.slug[0]}`)

  return <BlogDetail slugCompare={params?.slug[0]} data={dataAcf} dataDetailPost={dataDetailPost} />
}
