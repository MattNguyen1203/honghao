        ...
        <svg className='size-[3.3rem] absolute left-[0.7rem] top-[-0.25rem] shrink-0' xmlns="http://www.w3.org/2000/svg" width="58" height="56" viewBox="0 0 58 56" fill="none">
          ...
          <defs>
            <filter id="filter0_d_9373_13708" x="26" y="0" width="32" height="32" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
              ...
              <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_9373_13708" />
              <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_9373_13708" result="shape" />
            </filter>
          </defs>
        </svg>
        <div className="absolute z-10 top-1/2 -translate-x-1/2 left-1/2 -translate-y-1/2 w-[3.125rem] h-[3.125rem] shrink-0 blur-none rounded-[6.25rem] border-[4px] border-[rgba(255,255,255,0.15)]">
        </div>
      </div>
