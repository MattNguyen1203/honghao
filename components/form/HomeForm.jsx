    ...
    >
      <Form {...form}>
        <form
          ...
          className={`${
            isTourDetail ? 'w-[54.1875rem] md:!pr-[1.5rem]' : 'w-[34.75rem]'
        ...
        >
          ...
          >
            <Button
              className={`${
                isTourDetail && 'order-2 ml-[0.5rem]'
            ...
            {isTourDetail && (
              <div className='ml-[0.5rem] flex items-center order-3'>
                <svg
