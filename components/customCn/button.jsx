...
const buttonVariants = cva(
  'inline-flex px-8 py-4 xmd:py-[0.75rem] xmd:px-[1.5rem] xmd:h-[3rem] tablet:h-[5rem] h-[3.5rem] group items-center justify-center whitespace-nowrap rounded-md text-sm font-bold ring-offset-white ease-linear duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300 tablet:text-15',
  {
    variants: {
      variant: {
        default:
          'flex uppercase button text-white justify-center items-center gap-2 border border-orange-hover bg-orange-hover rounded-lg border-solid ',
        outline:
...
const Button = React.forwardRef(
  ({className, icon, variant, size, asChild = false, ...props}, ref) => {
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    mode='normal'
                    in2='shape'
                    result='effect1_innerShadow_10201_23415'
                  />
                </filter>
                <linearGradient
                  id='paint0_linear_10201_23415'
                  x1='4.53912'
                  y1='6'
                  x2='4.53912'
                  y2='6.892'
