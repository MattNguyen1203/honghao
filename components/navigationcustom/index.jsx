    ...
    <div className='relative z-50'>
      ...
      >
        <svg className='' xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
          <g className={'group-hover:fill-[#E64827] fill-transparent duration-300 ease-linear'} clip-path="url(#clip0_7452_38196)">
            <circle className={white ? 'stroke-white' : 'stroke-[#E64827]'} cx="20" cy="20" r="19.5" stroke="#E64827" />
            <path className={(white ? 'stroke-white' : 'group-hover:stroke-white stroke-[#E64827]') + '  duration-300 ease-linear'} d="M14.5 20L28 20" stroke="url(#paint0_linear_7452_38196)" stroke-width="2" />
            <g filter="url(#filter0_i_7452_38196)">
              {/* mui ten */}
              <path className={(white ? 'fill-white' : '') + ' group-hover:fill-white group-hover:translate-x-[0.09rem] duration-300 ease-linear'} d="M12 20L20 27L16.7816 20L20 13L12 20Z" fill="#E64827" />
            </g>
          </g>
          <defs>
            <filter id="filter0_i_7452_38196" x="12" y="13" width="28" height="18" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
