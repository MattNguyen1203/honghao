        ...
        <div className='flex md:w-[100rem] md:h-14 xl:container flex-col items-start gap-5 xmd:pb-2 md:pt-5'>
          <div className='flex items-center space-x-[0.25rem]'>
            ...
            <div className="flex justify-center items-center space-x-[0.5rem]">
              ...
              <svg className='w-[0.1875rem] xmd:mt-[0.1rem] h-[0.375rem] stroke-[#E64827] xmd:stroke-white' xmlns="http://www.w3.org/2000/svg" width="5" height="8" viewBox="0 0 5 8" fill="none">
                <path d="M1 1L4 4L1 7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
